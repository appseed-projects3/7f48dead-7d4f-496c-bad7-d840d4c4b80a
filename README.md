...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-03 19:39`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7f48dead-7d4f-496c-bad7-d840d4c4b80a.git
$ cd 7f48dead-7d4f-496c-bad7-d840d4c4b80a
```
